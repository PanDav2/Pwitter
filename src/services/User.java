...
public class User {
	...
	public static JSONObject findBySession(String session) throws JSONException {
		try
		{
			ArrayList<String> rslt = core.User.findBySession(session);
			JSONObject json = new JSONObject();
			JSONObject jsonUser = new JSONObject();
			json.put("statut", "ok");
			jsonUser.put("id", rslt.get(0));
	...
	public static JSONObject findById(String id) throws JSONException {
		try
		{
			ArrayList<String> rslt = core.User.findById(id);
			JSONObject json = new JSONObject();
			JSONObject jsonUser = new JSONObject();
			json.put("statut", "ok");
			jsonUser.put("id", rslt.get(0));
